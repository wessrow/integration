...
FORDONSPOSITION_URL = (
    "https://api.sl.se/fordonspositioner/GetData?" "type={}&pp=false&cacheControl={}"
)
...
RI4_URL = TRAFIKLAB_URL + "realtimedeparturesV4.json?key={}&siteid={}" "&timeWindow={}"
PU1_URL = (
    TRAFIKLAB_URL + "typeahead.json?key={}&searchstring={}"
    "&stationsonly=False&maxresults=25"
)
RP3_URL = (
    TRAFIKLAB_URL + "TravelplannerV3_1/trip.json?key={}&originExtId={}"
